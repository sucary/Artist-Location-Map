    ...
    return (
        <>
            {parseContentLinks(content).map((part, index) => {
                ...
                const className = 'font-medium text-primary-contrast app-dark:text-primary hover:text-primary-contrast-hover app-dark:hover:text-primary underline underline-offset-2';
