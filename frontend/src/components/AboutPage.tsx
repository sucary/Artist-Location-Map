        ...
        <PageLayout title={t('about.title')}>
            ...
            <PageSection>
                ...
                <a
                    ...
                    className="inline-flex items-center gap-2 text-sm text-primary-contrast hover:text-primary-contrast-hover"
                >
                        ...
                        <div key={credit.name}>
                            <div className="flex items-center gap-2">
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-sm font-medium text-primary-contrast hover:text-primary-contrast-hover"
                                >
                                    {credit.name}
                                </a>
                                {credit.license && (
