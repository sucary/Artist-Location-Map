...
export const HomeIcon: React.FC<IconProps> = ({ className = "w-5 h-5", ...props }) => (
    <svg aria-hidden="true" focusable="false" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} {...props}>
...
export const MusicIcon: React.FC<IconProps> = ({ className = "w-5 h-5", ...props }) => (
    <svg aria-hidden="true" focusable="false" viewBox="1 1 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} {...props}>
...
export const YoutubeIcon: React.FC<IconProps> = ({ className = "w-5 h-5", ...props }) => (
    <svg aria-hidden="true" focusable="false" viewBox="1 2.5 14 11" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} {...props}>
