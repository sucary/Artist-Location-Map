...
const ARTIST_BASE_COLUMNS = `
    ...
    COALESCE(ama.source_image, a.source_image) as source_image,
    COALESCE(ama.avatar_crop, a.avatar_crop) as avatar_crop,
    COALESCE(ama.profile_crop, a.profile_crop) as profile_crop,
        ...
        try {
            ...
            const candidatesResult = await pool.query(`
                ...
                WHERE p.is_private = false
                  AND COALESCE(ama.source_image, a.source_image) IS NOT NULL
